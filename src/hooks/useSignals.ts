...
const mockSignalsData: CorporateSignal[] = [
  {
    ...
    source_url: 'https://www.idx.co.id/StaticData/NewsAndAnnouncement/SR_TLKM_2025.pdf',
  ...
  },
  {
    ...
    source_type: 'CSR_PDF',
    source_url: 'https://www.astra.co.id/Sustainability/Report-2025.pdf',
  ...
  },
  {
    ...
    source_type: 'BEI_REPORT',
    source_url: 'https://www.idx.co.id/reports/SR_ENERGI_2025.pdf',
  ...
  },
  {
    ...
    industry_sector: 'Perbankan',
    source_type: 'NEWS',
    source_url: 'https://www.bca.co.id/csr-news',
