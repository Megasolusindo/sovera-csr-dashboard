                      ...
                      <td className="py-4 px-6 whitespace-nowrap">
                        <div className="flex flex-col items-start gap-1.5">
                          ...
                          <div className="flex items-center gap-1">
                            {comp.linkedin_url && comp.linkedin_status !== 'INVALID' && (
                              <a
                                href={comp.linkedin_url}
                                target="_blank"
                                rel="noopener noreferrer"
                                onClick={(e) => e.stopPropagation()}
                                className="w-5 h-5 rounded bg-blue-50 hover:bg-blue-100 text-blue-700 font-bold text-[9px] flex items-center justify-center border border-blue-200 transition-colors"
                                title="LinkedIn Profile (Verified)"
                              >
                                in
                              </a>
                            )}
                            {comp.instagram_url && comp.instagram_status === 'VALID' && (
                              <a
                                href={comp.instagram_url}
                                target="_blank"
                                rel="noopener noreferrer"
                                onClick={(e) => e.stopPropagation()}
                                className="w-5 h-5 rounded bg-pink-50 hover:bg-pink-100 text-pink-700 font-bold text-[9px] flex items-center justify-center border border-pink-200 transition-colors"
                            ...
                            {comp.facebook_url && (
                              <a
                                href={comp.facebook_url}
                                target="_blank"
                                rel="noopener noreferrer"
                                onClick={(e) => e.stopPropagation()}
                                className="w-5 h-5 rounded bg-indigo-50 hover:bg-indigo-100 text-indigo-700 font-bold text-[9px] flex items-center justify-center border border-indigo-200 transition-colors"
                                title="Facebook Page"
                              >
                                fb
                              </a>
                            ...
                            {comp.youtube_url && (
                              <a
                                ...
                                rel="noopener noreferrer"
                                onClick={(e) => e.stopPropagation()}
                                className="w-5 h-5 rounded bg-red-50 hover:bg-red-100 text-red-700 font-bold text-[9px] flex items-center justify-center border border-red-200 transition-colors"
